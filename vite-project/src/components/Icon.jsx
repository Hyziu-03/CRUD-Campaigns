...
function Icon() {
    return (
        <svg
            ...
            fill="none"
            viewBox="0 0 48 46"
            style={{ minWidth: "48px", minHeight: "46px" }}
            role="img"
            aria-label="Marketing campaigns icon"
            focusable="false"
        >
            <title>Marketing Campaigns</title>
            <desc>A stylized icon representing marketing campaigns with purple and blue gradient elements</desc>
            <path
                fill="#863bff"
